...
""" docstring """
#
# python launch_packer.py --prefix packer --platform base  --type beanstalk --disk multidisk  --virt hvm --instance t2.micro
# python launch_packer.py --prefix packer --platform base  --type beanstalk --disk multidisk  --virt pv --instance t1.micro
# python launch_packer.py --prefix packer --platform base  --type beanstalk --disk singledisk --virt hvm --instance t2.micro
# python launch_packer.py --prefix packer --platform base  --type beanstalk --disk singledisk --virt pv --instance t1.micro
# python launch_packer.py --prefix packer --platform rails --type beanstalk --disk multidisk  --virt hvm --instance t2.micro
# python launch_packer.py --prefix packer --platform rails --type beanstalk --disk multidisk  --virt pv --instance t1.micro
# python launch_packer.py --prefix packer --platform rails --type beanstalk --disk singledisk --virt hvm --instance t2.micro
# python launch_packer.py --prefix packer --platform rails --type beanstalk --disk singledisk --virt pv --instance t1.micro

# python launch_packer.py --prefix packer --platform base  --type ec2 --disk multidisk --virt hvm --instance t2.micro
# python launch_packer.py --prefix packer --platform base  --type ec2 --disk multidisk --virt pv --instance t1.micro
# python launch_packer.py --prefix packer --platform base  --type ec2 --disk singledisk --virt hvm --instance t2.micro
# python launch_packer.py --prefix packer --platform base  --type ec2 --disk singledisk --virt pv --instance t1.micro
# python launch_packer.py --prefix packer --platform ecs  --type ec2 --disk multidisk --virt hvm --instance t2.micro

# local-amzn-<disk>-<virt>_<prefix>-<platform>-<type>
# python launch_packer.py --prefix packer --platform ecs  --type ec2 --disk singledisk --virt hvm --instance t2.micro
# python launch_packer.py --prefix packer --platform ecs  --type beanstalk --disk multidisk --virt pv --instance t1.micro
# python launch_packer.py --prefix packer --platform ecs  --type beanstalk --disk multidisk --virt hvm --instance t2.micro
# python launch_packer.py --prefix packer --platform ecs  --type beanstalk --disk singledisk --virt pv --instance t1.micro
# python launch_packer.py --prefix packer --platform ecs  --type beanstalk --disk singledisk --virt hvm --instance t2.micro
...
hvm_beanstalk = 'aws-elasticbeanstalk-amzn-*x86_64-ruby-hvm*'
hvm_minimal = 'amzn-ami-minimal-hvm*'
hvm_beanstalk_ecs = 'aws-elasticbeanstalk-amzn-*x86_64-ecs-hvm-*'
hvm_minimal_ecs = 'amzn-ami-2016.03.e-amazon-ecs-optimized'

pv_beanstalk = 'aws-elasticbeanstalk-amzn-*x86_64-ruby-pv*'
...
repo_address = "54.84.207.213" # if not in main VPC, use the local address of 10.254.103.55
repo_dns = "shared-yumrepo-001.core.us-east-1.domain.com"
packer_binary = "/usr/local/bin/packer"
curl_binary = "/usr/bin/curl"
template_path = "/opt/scripts/packer/templates"
...
def write_packer_template(template_values, template_source, template_dest, virt_type):
    ...
    result = ""
    logging.info("[ EXEC  ] - Writing %s Template %s" % (virt_type, template_source))
...
def write_shell_template(template_values, template_source, template_dest):
    ...
    check_and_delete_file(template_dest)
    result = ""
    logging.info("[ EXEC  ] - Writing Repo Template %s" % (template_source))
    packer_env = jinja2.Environment(loader=jinja2.FileSystemLoader([template_path]))
    template = packer_env.get_template(template_source)
    result = template.render(template_values)
    os.open(template_dest, os.O_CREAT)
...
def copy_userdata_file(userdata_template_source, userdata_template_dest):
    ...
    template = env.get_template(userdata_template_source+".j2")
    result = template.render()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        metavar='',
        default="base",
        help="Platform of the build: rails, base, ecs"
    )
    ...
    # args.prefix = "Local_amzn-"+args.disk+"-"+args.virt+"_"+args.type+"-"+args.prefix.replace(" ", "-")+"-"+args.platform.lower()
    args.prefix = "Local_amzn-"+args.disk+"-"+args.virt+"_"+args.prefix.replace(" ", "-")+"-"+args.platform.lower()+"-"+args.type
    ...
    write_packer_template(packer_values, template_name+".j2", packer_template, args.virt)
    write_shell_template(shell_values, "shell.j2", shell_script)
    write_user_template("create_users.j2", createuser_dest)
